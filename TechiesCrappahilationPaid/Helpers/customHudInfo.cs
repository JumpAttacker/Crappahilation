...
{
    public static class CustomHUDInfo
    {
        ...
        public static Vector2 ScreenSize { get; } = new Vector2(RendererManager.ScreenSize.X, RendererManager.ScreenSize.Y);
        ...
        public static Vector2 GetHpBarPosition(Unit unit)
        {
            ...
            if (unit.IsAlly(EntityManager.LocalHero))
            {
